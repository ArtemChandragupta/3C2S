...
= Практика с проточной частью

Относительный оптимальный шаг:
$ dash(t) = t/b $

$ dash(t)_"opt" = 0.55 [180/(180-(alpha_0+alpha_1) ) sin(alpha_0)/sin(alpha_1) ]^(1/3) dot (1-dash(c)) $

Для рабочей лопатки:

$ dash(t)_"opt" = 0.55 [180/(180-(beta_1+beta_2^*) ) sin(beta_1)/sin(beta_2^*) ]^(1/3) dot (1-dash(c)) $
